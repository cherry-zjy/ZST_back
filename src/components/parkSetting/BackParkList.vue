<template>
  <div>
    ...
    <el-table :data="productList" style="width: 100%" :border='true'>
      <el-table-column label="停车场编号" prop="Name">
      </el-table-column>
      <el-table-column label="停车场名" prop="Name">
      </el-table-column>
      <el-table-column label="预约车位" prop="Name" sortable>
      </el-table-column>
      <el-table-column label="剩余车位" prop="Name" sortable>
      </el-table-column>
      <el-table-column label="总车位" prop="Name" sortable>
      </el-table-column>
      <el-table-column label="是否推荐" prop="Price">
        <template slot-scope="scope">
          <el-checkbox v-model="scope.row.Price">是/否</el-checkbox>
        </template>
      </el-table-column>
      <el-table-column label="优惠券" prop="Stock">
      </el-table-column>
